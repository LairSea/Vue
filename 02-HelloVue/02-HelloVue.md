...
​	在谷歌浏览器中按F12，在开发者模式中console控制台，改变vue对象的message值，页面显示也随之改变。----（**双向绑定数据**）

![image-20220915092727026](https://suhai.oss-cn-hangzhou.aliyuncs.com/images/image-20220915092727026.png)
...
![](https://suhai.oss-cn-hangzhou.aliyuncs.com/images/2.2.1-1.png)
